...
mapevent4_1_sp2.getMapPosition = function(currentPosition)
  return mapBase.getMapPosition(imgevent4_1_sp2, currentPosition)
end
...
mapevent4_1_sp2.checkMoveToPointPath = function(mapChessboard, start, target)
  return mapBase.checkMoveToPointPath(mapevent4_1_sp2, mapChessboard, start, target)
end
...
mapevent4_1_sp2.getRandomMoveAStep = function(mapChessboard)
  return mapBase.getRandomMoveAStep(imgevent4_1_sp2, mapChessboard)
end
