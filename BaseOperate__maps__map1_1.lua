...
map1_1.getMapPosition = function(currentPosition)
  return mapBase.getMapPosition(img1_1, currentPosition)
end
...
map1_1.checkMoveToPointPath = function(mapChessboard, start, target)
  return mapBase.checkMoveToPointPath(map1_1, mapChessboard, start, target)
end
...
map1_1.getRandomMoveAStep = function(mapChessboard)
  return mapBase.getRandomMoveAStep(map1_1, mapChessboard)
end
