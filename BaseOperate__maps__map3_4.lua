...
map3_4.getMapPosition = function(currentPosition)
  return mapBase.getMapPosition(img3_4, currentPosition)
end
...
map3_4.checkMoveToPointPath = function(mapChessboard, start, target)
  return mapBase.checkMoveToPointPath(map3_4, mapChessboard, start, target)
end
...
map3_4.getRandomMoveAStep = function(mapChessboard)
  return mapBase.getRandomMoveAStep(img3_4, mapChessboard)
end
