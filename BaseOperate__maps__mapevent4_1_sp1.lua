...
local imgevent4_1_sp1 = require 'BaseOperate__maps__imgevent4_1_sp1'
local mapevent4_1_sp1 = {}

-- 获取地图采样位置。由于地图可能超出一屏，所以这里可以定义多个采样位置。每次扫描都会对每个采样位置进行扫描
-- 标志位为地图四个角。每个采样位置只需定义一个角的坐标即可。
-- 还需要定义每个采样位置的地图矩阵与屏幕坐标的映射关系
mapevent4_1_sp1.getCheckpositionList = function()
  local list = {
    {
      leftTop = nil,
      rightTop = { 1709, 478 },
...
-- 获取地图棋盘和相关数据
mapevent4_1_sp1.getMapChessboard = function()
  return {
    width = 8,
    height = 5,
    obstacle = {
...
mapevent4_1_sp1.getMapPosition = function(currentPosition)
  return mapBase.getMapPosition(imgevent4_1_sp1, currentPosition)
end

mapevent4_1_sp1.getMoveVector = function(currentPosition, targetPosition)
  return mapBase.getMoveVector(imgevent4_1_sp1, currentPosition, targetPosition)
end

mapevent4_1_sp1.moveMapToCheckPosition = function(moveVector)
  return mapBase.moveMapToCheckPosition(imgevent4_1_sp1, moveVector)
end

mapevent4_1_sp1.scanMap = function(targetPosition, mapChessboard)
  return mapBase.scanMap(imgevent4_1_sp1, targetPosition, mapChessboard)
end

mapevent4_1_sp1.moveToPoint = function(targetPosition, point)
  return mapBase.moveToPoint(imgevent4_1_sp1, targetPosition, point)
end

mapevent4_1_sp1.checkMoveToPointPath = function(mapChessboard, start, target)
  return mapBase.checkMoveToPointPath(mapevent4_1_sp1, mapChessboard, start, target)
end

mapevent4_1_sp1.findClosestEnemy = function(mapChessboard)
  return mapBase.findClosestEnemy(imgevent4_1_sp1, mapChessboard)
end

mapevent4_1_sp1.getRandomMoveAStep = function(mapChessboard)
  return mapBase.getRandomMoveAStep(imgevent4_1_sp1, mapChessboard)
end

return mapevent4_1_sp1